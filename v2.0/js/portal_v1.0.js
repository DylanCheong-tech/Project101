    ...
    methods: {
        ...
        confirmEdit(code, row_target, form_submit_btn_id, form_id) {
            ...
            if (this.current_edit_obj.code != code) {
                $.ajax({
                    "url": "/deleteFiles/" + code.toUpperCase(),
                    "type": "get",
                    "dataType": "json"
                });
            }
        ...
        deleteExistingProduct() {
            ...
            for (index in deleteList) {
                ...
                $.ajax({
                    "async": false,
                    "url": "/deleteFiles/" + deleteList[index].toUpperCase(),
                    "type": "get",
                    "dataType": "json",
...
// var myrequest = new Request("https://storage.googleapis.com/plastic-products/CP-3535/Brown_1.jpg", {
//     method: "GET",
//     headers: myheader,
//     mode: "no-cors"
// })
...
//         renamed_files = [new File([blob.arrayBuffer()], "new testing.jpg")];

//         let files = new FileListItems(renamed_files);
//         console.log(files)
...
//         // document.getElementById("testing").appendChild(newImage);
//     })


const imageUrl = "https://storage.googleapis.com/plastic-products/CP-3535/Brown_1.jpg";
...
(async () => {
    ...
    reader.onloadend = () => {
        ...
        document.getElementById("test").src = base64data;
    }
})()
